...
class Tictuk extends sql
{
    ...
    function solicitarToken()
    {
        ...
        $client = $this->config->cargarConfiguracionPoliticasPorMedio($this->idRestaurante , 'TICTUK');
    ...
    function notificarTransferencia($codigo, $localOrigen, $localDestino, $usuario, $motivo, $direccion, $medio)
    {
        ...
        if(isset($validacionConsumoServicio) && $validacionConsumoServicio == 'APLICA'){
            ...
            // OBTENER RUTA
            $urlServicio = $this->serviceUrl->retorna_rutaWS($this->idRestaurante, "TICTUK", "TRANSFERENCIA");
    ...
    function tracking($objetoTracking, $medio)
    {
        ...
        if(isset($validacionConsumoServicio) && $validacionConsumoServicio == 'APLICA'){
            ...
            $urlServicio = $this->serviceUrl->retorna_rutaWS($this->idRestaurante, "TICTUK", "TRACKING");
