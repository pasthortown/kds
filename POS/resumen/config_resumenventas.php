...
include_once"../clases/clase_resumenVentas.php";
...
if(isset($_GET["cargarVentaTotalesCuentas"])){ 
	$lc_condiciones[0]=$periodo;
        $lc_condiciones[1]=$moneda;
	print $lc_config->fn_consultaValoresTotalesCuentas($lc_condiciones);
}
