...
if (\PHP_VERSION_ID < 70400) {
    ...
    if (!function_exists('utf8_encode')) {
        function utf8_encode($domain, $flags = 0, $variant = \INTL_IDNA_VARIANT_2003, &$idna_info = null) { return p\Idn::utf8_encode($domain, $flags, $variant, $idna_info); }
    }
} else {
    if (!function_exists('idn_to_ascii')) {
    ...
    if (!function_exists('utf8_encode')) {
        function utf8_encode($domain, $flags = 0, $variant = \INTL_IDNA_VARIANT_UTS46, &$idna_info = null) { return p\Idn::utf8_encode($domain, $flags, $variant, $idna_info); }
    }
}
