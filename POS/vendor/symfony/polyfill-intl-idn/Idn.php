...
final class Idn
{
     ...
     * @return string|false
     */
    public static function utf8_encode($domainName, $options = self::IDNA_DEFAULT, $variant = self::INTL_IDNA_VARIANT_UTS46, &$idna_info = [])
    {
        if (\PHP_VERSION_ID >= 70200 && self::INTL_IDNA_VARIANT_2003 === $variant) {
            @trigger_error('utf8_encode(): INTL_IDNA_VARIANT_2003 is deprecated', \E_USER_DEPRECATED);
        }
