...
if (!function_exists('utf8_encode')) {
    function utf8_encode(?string $domain, ?int $flags = IDNA_DEFAULT, ?int $variant = INTL_IDNA_VARIANT_UTS46, &$idna_info = null): string|false { return p\Idn::utf8_encode((string) $domain, (int) $flags, (int) $variant, $idna_info); }
}
