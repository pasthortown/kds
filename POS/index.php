...
// Verifica si se aplico un borrado recientemente
$aplicoBorradoCache = (isset($_GET['aplicado']) && $_GET['aplicado']) ? true : false;
?>
...
<head>
    ...
    <style>
        .btn-continuar-by-actualizacion{
            height: auto;
        }
    </style>
...
<body>  
    <input inputmode="none"  type="hidden" id="hid_ip" value="<?php echo $lc_ip; ?>"/>
    <input type="hidden" id="aplicoBorradoCache" name="aplicoBorradoCache" value="<?php echo $aplicoBorradoCache ?>">
    ...
    <div>
        <div>
            ...
            <p class="text-info" style="color: #FFF;text-align:center;">VERSION 1.22.1</p>
    ...
    <div class="panel-body">               
        <div class="row">
            <div class="col-xs-5">                            
                        ...
                        <div class="modal-dialog" style="width:700px;">
                            <div class="modal-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            <input inputmode="none"  type="text" class="form-control" id="ipestacion" disabled="disabled" value="<?php echo $lc_ip; ?>"/>
                                        </div>
                                    </div>
                                </div> 
                    ...
                    <div class="modal fade" id="mdlErrorReplica" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
                        <div class="modal-dialog" style="width:900px;">
                            <div class="modal-content">
                                ...
                                <br>
                                <div class="row">
                                    <div class="col-xs-3 text-right" style="color: #0000FF">
										<h5><b>Replica Aplicada</b></h5>
									</div>                                    
                                </div> 
                                <div class="row">  
                                ...
                                <div class="row">
                                    <div class="col-xs-3 text-right" style="color: #c71c1c">
										<h5><b>Error de Replica</b></h5>
									</div>                                    
                                </div> 
                                <div class="row">  
                                    <div class="col-xs-1 text-right"><h5></h5></div>
                ...
                <div class="row">                                   
                    <div class=" form-group">
                        <input inputmode="none"  type="password" class="form-control input-lg iniciarsesion" id="usr_clave" name="usr_clave" placeholder="Contraseña" autocomplete="off">
                    </div>                                     
                </div>
                ...
                <input inputmode="none"  type="hidden" id="txtTipo" name="txtTipo"/>
                <input inputmode="none"  type="hidden" id="txtEstacion" name="txtEstacion"/>
                <input inputmode="none"  type="hidden" id="txtIp" name="txtIp" value="<?php echo $lc_ip; ?>"/> 
            </div>                        
                                                        
            <div id="contenedorTeclado" class="col-xs-5">
                <div class="form-group">
                    <div class="row">
                        <div class="col-xs-4">
...
<div id="credencialesAdmin" style="min-height:87px">
    ...
    <div class="anulacionesSeparador">
        <div class="anulacionesInput">
			<span>
				<img src="imagenes/admin_resources/users_two_48.png" height="55px" width="55px" />
			</span>
			&nbsp;
...
<div id="credencialesAdminteclado">
...
<div id="IngresoFondos">
    ...
    <div class="anulacionesSeparador">
        <div class="anulacionesInput"><span><img src="imagenes/billete.png" height="55px" width="55px"></span> &nbsp;<input inputmode="none"  type="text" id="usr_admin_fondo" style="width: 380px; font-size: 20px;" readonly="readonly" />				
        </div>       
    </div>
</div>
<div id="IngresoFondosteclado" > 
    <table id="tabla_credencialesAdminfondo" style="text-align: center">
        <tr>
...
<input inputmode="none"  type="hidden" id="hid_idusuario" />
<input inputmode="none"  type="hidden" id="bandera" />
<input inputmode="none"  type="hidden" id="moneda" />
<input inputmode="none"  type="hidden" id="fechaAperturaPeriodo" />
<input inputmode="none" type="hidden" id="userPassword" value="<?php echo isset($_SESSION['userPassword']) ? $_SESSION['userPassword'] : ''; ?>" />
...
<script src="js/ajax_loguin.js"></script>
<script src="js/ajax_infoestacion.js"></script>
<script src="js/ajax_api_impresion.js"></script>    
<script src="js/ajax_pedido_localstore.js"></script>
</body>
</html>
