...
function Keypad() {
	...
	this.addKeyDef('X', 'vaciox', function(inst) { plugin._vacioValue(inst); });
	this.addKeyDef('XX', 'vacioxx', function(inst) { plugin._vacioValue(inst); });
	...
	this.regional[''] = { // Default regional settings
		...
		buttonStatus: 'Abrir Teclado Virtual', // Status text for trigger button
		closeText: 'Cerrar', // Display text for close link
		closeStatus: 'Cierra el Teclado Virtual', // Status text for close link
		clearText: 'Cancelar', // Display text for clear link
		clearStatus: 'Borra todos los caracteres', // Status text for clear link
		backText: 'Borrar', // Display text for back link
		backStatus: 'Elimina el caracter anterior', // Status text for back link
		spacebarText: 'Barra Espaciadora', // Display text for space bar
		spacebarStatus: 'Espacio', // Status text for space bar
		enterText: 'OK', // Display text for carriage return
		enterStatus: 'Aceptar', // Status text for carriage return
		tabText: '→Tab', // Display text for tab
		tabStatus: 'Horizontal tab', // Status text for tab
		vacioxText: '', // Display text for tx
		vacioxStatus: '', // Status text for x
		vacioxxText: '', // Display text for tx
		vacioxxStatus: '', // Status text for x
		shiftText: 'Shift', // Display text for shift link
		shiftStatus: 'Cambia a mayusculas/minusculas', // Status text for shift link
	...
	this._defaults = { // Global defaults for all the keypad instances
		...
		layout:[
				'1234567890'+this.X+this.BACK,
				this.SHIFT +'qwertyuiop',
				this.XX +'asdfghjkl'+this.CLEAR,
				this.XX +this.X +'zxcvbnm'+this.ENTER 
				
			],
		
		
		//layout: ['abcdefg', 'hijklmn', 'opqrstu', 'vwxyz' + this.BACK, '12345' + this.CLEAR, '67890' + this.ENTER ], // Layout of keys
		...
		beforeShow: null, // Callback before showing thSe keypad
