...
///////MODIFICADO POR: JOSE FERNANDEZ/////////////////////////
//////DESCRIPCION: SE VALIDO QUE EN EL TECLADO SOLO SE PUEDA//
//////////////////INGRESAR UNA SOLA VEZ EL PUNTO DECIMAL//////
//////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////// 
var lc_cantidad=1;
var x="0"; //n�mero en pantalla
var xi=1; //iniciar n�mero en pantalla: 1=si; 0=no;
var coma=0; //estado coma decimal 0=no, 1=si;
var ni=0; //n�mero oculto o en espera.
var op="no"; //operaci�n en curso; "no" =  sin operaci�n.
var lc_control=-1;//para verificar si es de salon o llevar
...
function fn_alfaNumerico(e){
		...
		borrarTodo="<button class='btnVirtualBorrar' onclick=fn_eliminarTodo("+$(e).attr("id")+")>Borrar</button>";
		btnOk ="<button class='btnVirtualOK' onclick=fn_btnOk("+$("#keyboard").attr("id")+")>OK</button>";
		
		$("#keyboard").css({
			display:"block",
			position: "absolute",
			top:posicion.top + 70,//30,
			left:leftPos,
		})
...
function fn_numerico(e){
		...
		borrarCaracter="<button class='btnVirtualBorrar' onclick=fn_eliminarNumero("+$(e).attr("id")+")>&larr;</button>";
		borrarTodo="<button class='btnVirtualOKpq' onclick=fn_eliminarTodo("+$(e).attr("id")+")>Borrar</button>";
...
function fn_agregarCaracter2(obj, valor)
{	//alert("primera"+coma)	;
