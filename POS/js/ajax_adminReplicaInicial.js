...
function ejecutarScript1(){
    ...
    $.getJSON("../adminReplicaInicial/config_adminReplicaInicial.php", send, function (datos) {
        ...
        if(datos==1){
            ...
            $('#Instalacion tbody tr:eq(0) td:eq(1)').html('Advertencia');
            $('#Instalacion tbody tr:eq(0) td:eq(2)').prepend('<span class="glyphicon glyphicon-warning-sign"></span>').css("color", "orange");
...
function verificarReplicaEnCurso(){
    send = {"VerificarReplicaEnTranscurso": 1};
    $.getJSON("../adminReplicaInicial/config_adminReplicaInicial.php", send, function (datos) {
        if(datos==0){
            var rdata=$('#data4').val();
            ...
            alertify
                .alert("Existe una replica en Proceso. Por favor espere 10 minutos", function(){
                    alertify.message('OK');
                });
            progreso(3);
            $('#regresa').click();
            ...
            alertify
                .alert("Existe una replica en Proceso. Por favor espere 3 minutos", function(){
                    alertify.message('OK');
                });
            progreso(3);
            $('#regresa').click();
            ...
            alertify
                .alert("Existe una replica en Proceso. Por favor espere 15 minutos", function(){
                    alertify.message('OK');
                });
            progreso(3);
            $('#regresa').click();
...
function carga(){
    ...
    $("#base4").prop("readonly", true);
}

function continuaReplica(){
    verificarReplicaEnCurso();
}
...
function modificar(){
    ...
    $.getJSON("../adminReplicaInicial/config_adminReplicaInicial.php", send, function (datos) {
        if(datos==1){
            execute4();
            $('#ejecucion tbody tr:eq(0) td:eq(1)').html('En Proceso....');
        }else{
            alert('Error');
        }
    });
...
function verificarVersion(directorio){
    ...
    $.getJSON("../adminReplicaInicial/config_adminReplicaInicial.php", send, function (datos) {
        if(datos==1){
            crearDirectorio(directorio);
            $('#data2').val(directorio.substring(0,6)+"Maxpoint"+"\\");
            $('#data2').prop("readonly", true);
            $('#data4').val(directorio.substring(0,6)+"Maxpoint"+"\\");
            $('#data4').prop("readonly", true);
...
function verificarDVersionI(directorio){
    ...
    $.getJSON("../adminReplicaInicial/config_adminReplicaInicial.php", send, function (datos) {
        if(datos==1){
            ...
            $('#log2').val(directorio.substring(0,6)+"Maxpoint"+"\\");
            $('#log2').prop("readonly", true);
            $('#log4').val(directorio.substring(0,6)+"Maxpoint"+"\\");
            $('#log4').prop("readonly", true);
            ejecutarScript1();
        }else{
            alertify
                .alert("El disco "+directorio.substring(0,2)+" no existe en el servidor.", function(){
...
function execute4(){
    $('#ejecucion tbody tr:eq(0) td:eq(2)').html("Creando base de Datos...");
    var send;
    var globalsrv=$("#server").val();
    var globalusr=$("#usr").val();
    var globalpass=$("#contrasena").val();
...
function fn_correr41(){
    $('#ejecucion tbody tr:eq(0) td:eq(2)').html("Creando Schemas y Tablas...");
    var nb=$("#base4").val();
    var globalsrv=$("#server").val();
    var globalusr=$("#usr").val();
    var globalpass=$("#contrasena").val();
...
function fn_correr42(){
    $('#ejecucion tbody tr:eq(0) td:eq(2)').html("Creando Funciones de base...");
    var nb=$("#base4").val();
    var globalsrv=$("#server").val();
    var globalusr=$("#usr").val();
    var globalpass=$("#contrasena").val();
...
function fn_correr43(){
    $('#ejecucion tbody tr:eq(0) td:eq(2)').html("Creando Vistas...");
    var nb=$("#base4").val();
    var send;
    var globalsrv=$("#server").val();
    var globalusr=$("#usr").val();
...
function fn_correr44(){
    $('#ejecucion tbody tr:eq(0) td:eq(2)').html("Creando Stores...");
    var nb=$("#base4").val();
    var send;
    var globalsrv=$("#server").val();
    var globalusr=$("#usr").val();
...
function fn_correr45(){
    $('#ejecucion tbody tr:eq(0) td:eq(2)').html("Creando Usuarios de base...");
    var send;
    var cadena=$("#cadena4").val();
    var tienda=$("#tienda4").val();
    var nb=$("#base4").val();
...
function Ejecutar4(){
    ...
    send.globalpass=globalpass;
    $.getJSON("../adminReplicaInicial/config_adminReplicaInicial.php", send, function (datos) {
        $('#ejecucion tbody tr:eq(0) td:eq(2)').html('');
    })
        .done(function() {
...
function borrarArchivosReplica() {
    var send;
    send = {"BorrarTodos": 1};
    $.getJSON("../adminReplicaInicial/config_adminReplicaInicial.php", send, function (datos) {
    });
...
function ejecutarScript5(){
    $('#ejecucion tbody tr:eq(2) td:eq(1)').html('Descargando Informaci&oacute;n....');
    $('#ejecucion tbody tr:eq(2) td:eq(2)').prepend('<span class="glyphicon glyphicon-download-alt"></span>');
    var send;
    var cadena=$("#cadena4").val();
    var tienda=$("#tienda4").val();
    var nb=$("#base4").val();
...
function ejecutarBajada(){
    ...
    send.globalpass=globalpass;
    $.get( "../adminReplicaInicial/config_adminReplicaInicial.php",send,function() {
        $('#ejecucion tbody tr:eq(2) td:eq(2)').prepend('');
    })
        .done(function() {
...
function cargarRestaurante(tienda){
    ...
    $.ajax({
        ...
        success: function (datos) {
            ...
            $("#tienda4").change(function () {
                var lc_restaurante = $("#tienda4 option:selected").text();
                $("#cargandoi").show();
                $("#base4").val("MAXPOINT_" + lc_restaurante);
                $("#cargandoi").hide();
            });
        }});
...
function ejecutarScriptsLinked(){
    $("#ejecutalinkeds").show();
    var send;
    var globalsrv = $("#server").val();
    var globalusr = $("#usr").val();
    var globalpass = $("#contrasena").val();
    if (globalpass != '' && globalusr != '' && globalsrv != '') {
        send = {"Conexion": 1};
        send.srv = globalsrv;
        send.usr = globalusr;
        send.pass = globalpass;
        $.getJSON("../adminReplicaInicial/config_adminReplicaInicial.php", send, function (datos) {
            if (datos == 1) {
                send = {"CrearLinkedServer": 1};
                send.globalsrv = globalsrv;
                send.globalusr = globalusr;
                send.globalpass = globalpass;
                $.get("../adminReplicaInicial/config_adminReplicaInicial.php", send, function () {
                    ...
                    .done(function () {
                        alertify.success('Linked Server creado');
                        $("#ejecutalinkeds").hide();
                    })
                    .fail(function () {
                        alertify.success('Error al crear Linked Server');
                        $("#ejecutalinkeds").hide();
                    })
