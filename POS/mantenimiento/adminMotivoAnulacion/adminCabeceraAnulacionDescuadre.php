...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Configuraci&oacute;n Motivo Anulaci&oacute;n</title>
        <!--------------------------------ESTILOS-------------------------------------------->
        ...
        <script type="text/javascript" src="../../js/ajax_adminmotivoanulacion.js"></script>
    ...
    <body>
            ...
            <div class="inferior">
                ...
                <div class="panel panel-default" id="botonesTodos">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-sm-8"><h5>Lista de Motivo Anulaci&oacute;n</h5>
                                <div id="opciones_estados" class="btn-group" data-toggle="buttons">
                                    <label class="btn btn-default btn-sm active" onclick="fn_OpcionSeleccionada('Activos');"><input inputmode="none"  id="opt_Activos" type="radio" value="Activos" checked="" autocomplete="off" name="estados" />Activos</label>
                ...
                <div id="motivoanulacion">
                    <table class="table table-bordered table-hover" id="tabla_motivoanulacion" border="1" cellpadding="1" cellspacing="0">
                    </table>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header panel-footer">
                        ...
                        <h4 class="modal-title" id="titulomodalNuevo">Nuevo Motivo de Anulaci&oacute;n: </b></h4>
                    </div>
                    <br/>
        ...
        <input inputmode="none"  type="hidden" id="txt_idmotivoanulacion" />
