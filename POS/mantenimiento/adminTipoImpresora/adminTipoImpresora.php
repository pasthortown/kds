...
<script type="text/javascript" src="../../js/ajax_admintipoimpresora.js"></script>
        ...
        <div class="inferior">
            ...
            <div class="panel panel-default">
				<div class="panel-heading">
                    <div class="row">
                    		<div class="col-sm-8"><h5>Lista de Tipos de Impresora</h5>
         	...
         	<div id="tipo_impresora">
            	<table class="table table-bordered table-hover" id="tabla_tipo_impresora" border="1" cellpadding="1" cellspacing="0">
      			</table>
            </div>
...
<!--<div class="contenedor" >
  <div class="inferior" align="center" > </br>
    <div id="tabla_canales_impresion">
      <table class="table table-bordered table-hover" id="canales_impresion" border="1" cellpadding="1" cellspacing="0">
      </table>
    </div>
  </div>
</div>-->
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header panel-footer">
        ...
        <h4 class="modal-title" id="titulomodalNuevo">Nuevo Tipo de Impresora: <b></h4>
      </div>
        </br>
      ...
      <div class="modal-body">       
             ...
             <!-- <div class="row">-->
                ...
                <div class="row">
                  <div class="col-xs-1"></div>
                  <div class="col-xs-4">
                    <h5>C&oacute;digo Apertura Caja:</h5>
                  </div>
                  <div class="col-xs-6">
                    <div class="form-group" class="col-xs-1"> 
                        <input inputmode="none"  style="text-align:center" class="form-control" maxlength="50" id="txt_codigoaperturacaja"/>                    	
                    </div>
                  </div>
                  <div class="col-xs-1"></div>
                </div>
                ...
                <div class="row">
                  <div class="col-xs-1"></div>
                  <div class="col-xs-4">
                    <h5>C&oacute;digo Corte Papel:</h5>
                  </div>
                  <div class="col-xs-6">
                    <div class="form-group" class="col-xs-1"> 
                        <input inputmode="none"  style="text-align:center" class="form-control" maxlength="50" id="txt_codigocortepapel"/>                    	
                    </div>
                  </div>
                  <div class="col-xs-1"></div>
                </div>
                ...
                <div class="row">
                  <div class="col-xs-1"></div>
                  <div class="col-xs-4">
                    <h5>C&oacute;digo Impresi&oacute;n Normal:</h5>
                  </div>
                  <div class="col-xs-6">
                    <div class="form-group" class="col-xs-1"> 
                        <input inputmode="none"  style="text-align:center" class="form-control" maxlength="50" id="txt_codigoimpresionnormal"/>                    	
                    </div>
                  </div>
                  <div class="col-xs-1"></div>
                </div>
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div align="right" class="col-xs-12">
               Est&aacute; Activo? <input inputmode="none"  type="checkbox" id="optionmod" checked="checked">      
      </div>
      </br>
      </br>
      <div class="modal-body">       
             ...
             <!-- <div class="row">-->
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    <div class="form-group" class="col-xs-1"> 
                        <input inputmode="none"  style="text-align:center" class="form-control" maxlength="50" id="txt_codigoaperturacajaMod"/>                    	
                    </div>
                  </div>
                  <div class="col-xs-1"></div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    <div class="form-group" class="col-xs-1"> 
                        <input inputmode="none"  style="text-align:center" class="form-control" maxlength="50" id="txt_codigocortepapelMod"/>                    	
                    </div>
                  </div>
                  <div class="col-xs-1"></div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    <div class="form-group" class="col-xs-1"> 
                        <input inputmode="none"  style="text-align:center" class="form-control" maxlength="50" id="txt_codigoimpresionnormalMod"/>                    	
                    </div>
                  </div>
                  <div class="col-xs-1"></div>
                </div>
