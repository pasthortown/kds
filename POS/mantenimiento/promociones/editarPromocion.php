...
$tipoCuponObj = new TipoCuponController($conexionTienda);
$tiposCuponActual = $tipoCuponObj->tiposCupon($promocion);
...
<div class="col-md-10">
    ...
    <ul class="nav nav-tabs">
        <li role="presentation" class="active"><a href="#PromocionGeneral" aria-controls="home" role="tab"
                                                  data-toggle="tab"><h4 class="panel-title"> 1.- Datos Generales </h4>
            </a></li>
        <li role="presentation"><a href="#ProductosRequeridosPromocion" aria-controls="profile" role="tab"
                                   data-toggle="tab"><h4 class="panel-title"> 2.- Productos Requeridos</h4></a></li>
        <li role="presentation"><a href="#RestaurantesAplicaPromocion" aria-controls="profile" role="tab"
                                   data-toggle="tab"><h4 class="panel-title"> 3.- Restaurantes Requeridos</h4></a></li>
        <li role="presentation"><a href="#BeneficiosPromocion" aria-controls="profile" role="tab" data-toggle="tab"><h4
                        class="panel-title"> 4.- Beneficios Promoción</h4></a></li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane active" id="PromocionGeneral">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input inputmode="none"  id="Nombre" value="<?php echo $promocion['Nombre']; ?>"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input inputmode="none"  id="Nombre_imprimible"
                                           onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
                                           value="<?php echo $promocion['Nombre_imprimible']; ?>" data-toggle="tooltip"
                                           title="Nombre Imprimible" placeholder="Nombre Imprimible"
                                           class="form-control" type="text">
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class='input-group date'>
                                        <input inputmode="none"  type='text' class="form-control" id='Activo_desde'
                                               ...
                                               value="<?php echo $promocion['Activo_desde']; ?>"/>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class='input-group date'>
                                        <input inputmode="none"  type='text' class="form-control" id='Activo_Hasta' placeholder="Hasta"
                                               ...
                                               value="<?php echo $promocion['Activo_Hasta']; ?>"/>
                                        <span class="input-group-addon">
                                             		  <span class="glyphicon glyphicon-calendar"></span>
                                          			</span>
                                    </div>
                        ...
                        <li class="list-group-item" style="background-color:#FFFFFF">
                            ...
                            <div align="center" id="categoriasRestricciones">
                                ...
                                for ($i = 0; $i < $longitud; $i++) {
                                    ...
                                    if(array_key_exists($idCategoriaActual,$tiposCuponActual)){
                                        $chequeado = " checked='true' ";
                                        $mostarSeccion = true;
                                        $tipoActual = $tiposCuponActual[$idCategoriaActual];
                                        $seccionesMostrar[]=$tipoActual["Descripcion"];
                                    }
                                    ?>
            ...
            <?php if (in_array("TIEMPO",$seccionesMostrar)) {
                $mostrar = "style='display:block;'";
            } else {
                $mostrar = "style='display:none;'";
            } ?>
            <div class="panel panel-default" id="resticcion-tiempo" <?php echo $mostrar; ?> >
                <!-- Default panel contents -->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="text-left"><h5>Habilitar / Deshabilitar :
                                            <input inputmode="none"  id="Requiere_dias"
                                                   onClick="enableRequiereDias();" <?php if ($promocion['Requiere_dias'] == 1) {
                                    ...
                                    <table class="table table-bordered table-sm m-0">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <label class="custom-control custom-checkbox">
                                                    <input inputmode="none"  type="checkbox" id="5" <?php
                                                    if ($promocion['Requiere_dias'] == 0) {
                                                        echo "disabled='disabled'";
                                                    }
                        ...
                        <div class="col-md-6">
                            <h4><span class="label" style="background-color:<?php echo $color1; ?>"> Horarios  </span>
                            </h4>
                                ...
                                <div class="col-md-12">
                                    <div class="text-left">
                                        <h5>Habilitar / Deshabilitar :
                                            <input inputmode="none"  id="Requiere_horario" onclick="enableRequiereHorario();" <?php
                                            if ($promocion['Requiere_horario'] == 1) {
                                                echo "checked='checked'";
                                            }

                                            if ($promocion['Horario_canjeable'] != "") {
                                                $horarios = explode(',', $promocion['Horario_canjeable']);
                                            }
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input inputmode="none"  class="form-control horario"
                                               id="horarioDesde" <?php if ($promocion['Requiere_horario'] == 0) {
                                            echo "disabled='disabled'";
                                        } ?> value="<?php
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input inputmode="none"  class="form-control horario"
                                               id="horarioHasta" <?php if ($promocion['Requiere_horario'] == 0) {
                                            echo "disabled='disabled'";
                                        } ?> value="<?php
                                        if ($promocion['Horario_canjeable'] != "") {
                                            echo $horarios[1];
            ...
            <?php if (in_array("NUMERICO",$seccionesMostrar)) {
                $mostrar = "style='display:block;'";
            } else {
                $mostrar = "style='display:none;'";
            } ?>
            <div class="panel panel-default" id="restriccion-numericas" <?php echo($mostrar); ?> >
                <!-- Default panel contents -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input inputmode="none"  class="form-control horario" id="Limite_canjes_total"
                                       value="<?php echo $promocion['Limite_canjes_total']; ?>"
                                       placeholder="Límite Canjes Total" onKeyPress="return justNumbers(event);">
                            </div>

                            <div class="col-md-6">
                                <div class="text-left"><h5>Límite Canjes Cliente :</h5></div>
                                <input inputmode="none"  class="form-control horario" id="Limite_canjes_cliente"
                                       value="<?php echo $promocion['Limite_canjes_cliente']; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input inputmode="none"  class="form-control horario" id="Bruto_minimo_factura"
                                       value="<?php echo $promocion['Bruto_minimo_factura']; ?>"
                                       placeholder="Bruto Minimo Factura" onKeyPress="return justNumbers(event);">
                            </div>

                            <div class="col-md-6">
                                <div class="text-left"><h5>Bruto Maximo Factura:</h5></div>
                                <input inputmode="none"  class="form-control horario" id="Bruto_maximo_factura"
                                       value="<?php echo $promocion['Bruto_maximo_factura']; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input inputmode="none"  class="form-control horario" id="Cantidad_minima_productos_factura"
                                       value="<?php echo $promocion['Cantidad_minima_productos_factura']; ?>"
                            ...
                            <div class="col-md-6">
                                ...
                                <input inputmode="none"  class="form-control horario" id="Maximo_canje_multiple"
                                       value="<?php echo $promocion['Maximo_canje_multiple']; ?>"
            ...
            <br>
            <?php if (in_array("USUARIO",$seccionesMostrar)) {
                $mostrar = "style='display:block;'";
            } else {
                $mostrar = "style='display:none;'";
            } ?>
            <div class="panel panel-default" id="restriccion-usuario" <?php echo($mostrar); ?> >
                <!-- Default panel contents -->
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <h4><span class="label" style="background-color:<?php echo $color3; ?>"> Edad Usuarios </span>
                        </h4>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="text-left"><h5>Habilitar / Deshabilitar :
                                            ...
                                            if ($promocion['Rango_edad'] != "") {
                                                $edades = explode(',', $promocion['Rango_edad']);
                                            }


                                            ?> onClick="enableRequiereRangoEdad();" type="checkbox" class="alert-info">
                                        </h5>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="text-left"><h5>Desde :</h5></div>
                                        <input inputmode="none"  <?php
                                        if ($promocion['Requiere_rango_edad'] == 0) {
                                            echo "disabled='disabled'";
                                        }

                                        ?> class="form-control horario" id="edadDesde" value="<?php
                                        if ($promocion['Rango_edad'] != "") {
                                            echo $edades[0];
                                        }
                                        ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-left"><h5>Hasta :</h5></div>
                                        <?php
                                        //	$edadHasta = substr($promocion['Rango_edad'], 2, 2);
                                        //	echo $edadHasta;
                                        ...
                                        ?> class="form-control horario" id="edadHasta" value="<?php
                                        if ($promocion['Rango_edad'] != "") {
                                            echo $edades[1];
                                        }
                                        ?>"
            ...
            <?php if (in_array("TIPO VENTA",$seccionesMostrar)) {
                $mostrar = "style='display:block;'";
            } else {
                $mostrar = "style='display:none;'";
            } ?>
            <div class="panel panel-default" id="restriccion-tipoventa" <?php echo $mostrar; ?> >
                <!-- Default panel contents -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="text-left"><h5>Habilitar / Deshabilitar :
                                            <input inputmode="none"  id="Requiere_canal" onClick="enableRequiereCanal();" <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            ?>
                                                id="idsCanal" multiple class="form-control" <?php
                                        if ($promocion['Requiere_canal'] == 0) {
                                            echo "disabled='disabled'";
                                        }
                                        ?> name="states[]">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <!--  <div class="col-md-12">
                                        <h4><span class="label label-default"> Acumulador</span></h4>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <div role="tabpanel" class="tab-pane" id="procat" style="min-height: 80px">
                                                <div id="dsct_apld_id">
                                                    <div class="row">
                ...
                <div class="panel-body">
                    <div class="row">
						...
						<pre class="control-label" style="background-color:#F5F5F5"><h5><span
                                        ...
                                        aria-hidden="true"></span> Deshabilitar : <input inputmode="none"  id="Requiere_productos"
                                                                                         onClick="enableRequiereProductos()" <?php if ($promocion['Requiere_productos'] == 1) {
                                    echo "checked='checked'";
                                }
                                ?> type="checkbox">	 </h5></pre>


                            <div class="panel panel-default"
                                 id="panel-productos-requeridos" <?php if ($promocion['Requiere_productos'] == 0) {
                ...
                <div class="panel-body">
                    <div class="row">
						...
						<pre class="control-label" style="background-color:#F5F5F5"><h5><span
                                        class="glyphicon glyphicon-ok" aria-hidden="true"></span> Habilitar / <span
                                        class="glyphicon glyphicon-remove"
                                        aria-hidden="true"></span> Deshabilitar : <input inputmode="none"  id="Requiere_restaurante"
                                                                                         onClick="enableRequiereRestaurantes()"
                                                                                         type="checkbox" <?php if ($promocion['Requiere_restaurante'] == 1) {
                                    echo "checked='checked'";
                                }
                                ?>>	 </h5></pre>
                            <div class="panel panel-default"
                                 id="panel-restaurantes-requeridos" <?php if ($promocion['Requiere_restaurante'] == 0) {
                                echo 'style="display:none"';
                            } else {
                                echo 'style="display:block"';
                            }
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="group-result" align="center">
                                                        <div id="btnAgregarTodosRestaurantes" class="btn btn-success"
                                                        ...
                                                        <div id="btnAgregarTodosRestaurantes" class="btn btn-primary "
                                                    ...
                                                    <div id="RestaurantesTodos" class="col-lg-12"
                                                         style="display:block;">
                                                        <!-- Busqueda -->
...
<!-- Inicio Tab -->
<button type="button" class="btn btn-primary" onClick="verificarDatos();"> Actualizar Promoción</button>
...
<script type="text/javascript" src="../../js/ajax_editpromociones.js"></script>
