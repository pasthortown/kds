...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
            ...
            <div class="modal-dialog" style="width:800px;">
                <div class="modal-content">
                    <div class="modal-header active panel-footer">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-6"><h4><b id="lblOrigen">Origen Venta</b></h4></div>
                            </div>
                            <div class="row">
                                <div class="col-xs-2 text-right"><h6><b>Local Envia</b></h6></div>
                                <div class="col-xs-4">
                                    <div class="form-group">
                                ...
                                <div class="col-xs-2 text-right"><h6><b>Base de Datos</b></h6></div>
                                <div class="col-xs-4">
                                    <div class="form-group">
                                        <input inputmode="none"  id="inDBLocalOrigen" class="form-control" type="text" value=""/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-6"><h4><b id="lblDestino">Destino Venta</b></h4></div>
                            </div>
                            <div class="row">
                                <div class="col-xs-2 text-right"><h6><b>Local Recibe</b></h6></div>
                                <div class="col-xs-4">
                                    <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <div class="form-group">
                                        <input inputmode="none"  type="text" id="inBDLocalDestino" class="form-control" value=""/>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript" src="../../js/ajax_transferenciaRestaurante.js"></script>
    </body>
</html>