...
<title>Canales de Impresion</title>
	<!---------------------------------------------------
                           ESTILOS
    ----------------------------------------------------->
...
<script type="text/javascript" src="../../js/ajax_admincanalesimpresion.js"></script>
...
<div class="superior">
  ...
  <div class="tituloPantalla">
    <h1>CANALES DE IMPRESI&Oacute;N</h1>
  </div>
</div>
</br>
...
<div class="contenedor">
        ...
        <div class="panel panel-default">
				<div class="panel-heading">
                    <div class="row">
                    		<div class="col-sm-8"><h5>Lista de Canales de Impresi&oacute;n</h5>
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header panel-footer">
        ...
        <h4 class="modal-title" id="titulomodalNuevo">Nuevo Canal de Impresi&oacute;n: </h4>
      </div>
      <br>
      ...
      <div class="modal-body">       
              ...
              <!--<div class="row">-->
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    <div class="form-group" class="col-xs-1">
                        <input inputmode="none"  style="text-align:center" class="form-control" id="txt_cadena" readonly="readonly" />                    	<input inputmode="none"  id="txt_idcadena" type="hidden"/> 
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    <div class="form-group" class="col-xs-1">
                        <input inputmode="none"  style="text-align:center" class="form-control" maxlength="20" id="txt_descripcion"/>                    	
                    </div>
                  </div>
                  <div class="col-xs-1"></div>
                </div>
      ...
      <div class="modal-body">       
             ...
             <!-- <div class="row">-->
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    <div class="form-group" class="col-xs-1">
                        <input inputmode="none"  style="text-align:center" class="form-control" id="txt_cadenaMod" readonly="readonly" />                    	<input inputmode="none"  id="txt_idcadena" type="hidden"/> 
                        <input inputmode="none"  type="hidden" name="mod_magid" id="mod_magid"/>
                    </div>
                  </div>
                  <div class="col-xs-1"></div>
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    <div class="form-group" class="col-xs-1">
                        <input inputmode="none"  style="text-align:center" class="form-control" maxlength="20" id="txt_descripcionmod"/>                    	
                    </div>
                  </div>
                  <div class="col-xs-1"></div>
                </div>
...
<input inputmode="none"  type="hidden" id="txt_idcanalesimpresion"/>
