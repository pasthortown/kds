...
<title>Configuraci&oacute;n Tipo Formas Pago</title>
	<!---------------------------------------------------
                           ESTILOS
    ----------------------------------------------------->
...
<script type="text/javascript" src="../../js/ajax_admintipoformaspago.js"></script>
        ...
        <div class="inferior">
            ...
            <div class="panel panel-default" id="botonesTodos">
				<div class="panel-heading">
                    <div class="row">
                    		<div class="col-sm-8"><h5>Lista Tipo Formas de Pago</h5>
         	...
         	<div id="tipoformaspago">
            	<table class="table table-bordered table-hover" id="tabla_tipoformaspago" border="1" cellpadding="1" cellspacing="0">
      			</table>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header panel-footer">
        ...
        <h4 class="modal-title" id="titulomodalNuevo">Nuevo Tipo Formas de Pago: </b></h4>
      </div>
       </br>
...
<input inputmode="none"  type="hidden" id="txt_idtipoformaspago"/>
