...
<head>
    ...
    <!--<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">-->
    <link href="../css/pagina/smart_wizard_all.min.css" rel="stylesheet" type="text/css" />
...
<body style="overflow-y: auto" onload="fn_ValidarControlEstacionActivo();">
    ...
    <input inputmode="none" id="politicaConfirmacionEliminarTodo" type="hidden"
        value="<?php echo $politicaConfirmacionEliminarTodo ?>" />
    ...
    ?>
    <input inputmode="none" type="hidden" name="bloqueo" id="bloqueo"
    ...
    <div id="formCobrar">
        ...
        <input inputmode="none" type="hidden" name="unificacion_transferencia_de_venta"
            id="unificacion_transferencia_de_venta" value="<?= $unificacion_transferencia_de_venta ?>" />

        <input inputmode="none" type="hidden" name="hide_numeroCuenta" value="<?php echo $numSplit; ?>"
        ...
        <input inputmode="none" type="hidden" name="hide_num_Pers" id="hide_num_Pers"
            value="<?php echo $num_Pers; ?>" />
        ...
        <input inputmode="none" id="hide_turneroActivo" type="hidden"
            value="<?php echo $_SESSION["turneroActivo"]; ?>" />
        <input inputmode="none" id="hide_turneroURl" type="hidden" value="<?php echo $_SESSION["turneroURl"]; ?>" />
        <input inputmode="none" id="hide_turneroHabilitadoPorEstacion" type="hidden"
            value="<?php echo $_SESSION["habilitadoPorEstacion"]; ?>" />
        <!-- Configuracion Kiosko - Activo -->
        <input inputmode="none" type="hidden" id="hide_configuracionKioskoActivo"
            value="<?php echo $configuracionKioskoActivo; ?>" />
        ...
        <input inputmode="none" type="hidden" id="hide_ordenesKioskoURL_http"
            value="<?php echo $ordenesKioskoURL_http; ?>" />
        ...
        <input inputmode="none" type="hidden" id="hide_configuracionPickupActivo"
            value="<?php echo $configuracionPickupActivo; ?>" />
        <!-- Verificar la politica para cargar Socket de Notificaciones Pickup -->
        <input inputmode="none" type="hidden" id="hide_politica_recibe_notificacion_pickup"
        ...
        <input inputmode="none" type="hidden" name="num_puntosIniciales" id="num_puntosIniciales"
        ...
        <input inputmode="none" type="hidden" name="num_puntos_plusActualiniciales" id="num_puntos_plusActualiniciales"
            value="" />

        <input inputmode="none" type="hidden" name="puntosPorPluNoAgrupado" id="puntosPorPluNoAgrupado" value="0" />

        <input inputmode="none" type="hidden" name="hide_PerteneceGrupoAmigos" id="hide_PerteneceGrupoAmigos"
            value="<?php echo $PerteneceGrupoAmigos; ?>" />


        <input inputmode="none" type="hidden" name="hide_fb_econtroDatos" id="hide_fb_econtroDatos"
            value="<?php echo $fb_econtroDatos; ?>" />
        <input inputmode="none" type="hidden" name="hide_fb_status" id="hide_fb_status"
            value="<?php echo $fb_status; ?>" />

        <input inputmode="none" type="hidden" name="fdzn_cedula" id="fdzn_cedula" value="<?php echo $fb_document; ?>" />

        <input inputmode="none" type="hidden" name="simboloMoneda" id="simboloMoneda"
            value="<?php echo $simboloMoneda; ?>" />
        <input inputmode="none" type="hidden" name="fdzn_nombre_cliente" id="fdzn_nombre_cliente"
    ...
    <div id="pnt_rdn_pdd_mxpnt" class="pnt_rdn_pdd_mxpnt">
        ...
        <div id="rdn_pdd_brr_nfmcn" class="rdn_pdd_brr_nfmcn">
            <div id="cntdr_mn_dnmc_stcn" style="width: 260px; height: 65px;">
                ...
                <input inputmode="none" name="Que alcanza" type="button" id='queAlcanza'
                    onclick="fn_abuscarProductosQuemeAlcanza()" class="boton_Accion_Bloqueado_puntos queAlcanza_activo"
                    alt="Guardar Cuenta" />
            </div>
            ...
            <div id="nfrmcn_srs_sstm" class="nfrmcn_srs_sstm" onclick="fn_salirSistema()"
        ...
        <div id="rdn_pdd_ctgrs_prdcts" class="rdn_pdd_ctgrs_prdcts">
            ...
            <div id="cnt_rdn_pdd_btns" class="cnt_rdn_pdd_btns" style="width: 770px; position: initial !important">
                <button name="Menu" type="button" id="boton_sidr" value="Menu" class="boton_Accion position-relative"
                ...
                <input inputmode="none" name="Actualizar" type="button" id="boton_ref" alt="Actualizar"
                    class="boton_Accion refresh_activo classDisabled" onclick="fn_actualizar()" />
                <input inputmode="none" name="Guardar Cuenta" type="button" servicio="2" id='Volver'
                    onclick="fn_volver(<?php echo "'$mesa_id'"; ?>)" disabled="disabled"
                    class="boton_Accion_Bloqueado guardar_activo classDisabled" alt="Guardar Cuenta" />
                <input inputmode="none" name="Comentar" type="button" id='comentar' onclick='fn_comentar()'
                    alt="Comentar" class="boton_Accion_Bloqueado comentar_activo classDisabled" disabled="disabled" />
                <input inputmode="none" name="Eliminar" type="button" id='btn_eliminarElemnto'
                    onclick='fn_validarAnulacion()' alt="Eliminar"
                    class="boton_Accion_Bloqueado eliminar_bloqueado classDisabled" disabled="disabled" />
                <input inputmode="none" name="Cantidad" type="button" id='agregarCantidad'
                    class="boton_Accion_Bloqueado cantidad_activo classDisabled" alt="Cantidad" disabled="disabled" />
                <!-- DESACTIVAR BOTÓN DE CUPON EN LA PANTALLA TOMA DE PEDIDO
                    ...
                    -->
                <input inputmode="none" name="Cobrar" type="button" id='cobrar'
                    onclick='fn_cobrar(<?php echo $numSplit; ?>)' class="boton_Accion_Bloqueado ok_activo classDisabled"
                    alt="Pagar" disabled="disabled" />
                ...
                <button id="btnArmarPicada" class="boton_Accion position-relative" style="padding: 2px 12px; margin-right: 4px; height: 89%;<?php if (!$pedidoAplicaPicada)
                    echo ' display: none;'; ?>" type="button" onclick="armarPicada()">
                    Armar Picada
                </button>

                <input inputmode="none" type="button" id="etiqueta_cantidad" class="boton_Cantidad" value="x1"
                    disabled="disabled" />
            </div>
        </div>
    ...
    <div id="rdn_pdd_brr_ccns" class="menu_desplegable">
        ...
        <div id="cnt_mn_dsplgbl_pcns_zqrd" class="modal_opciones_zqd">
            <input inputmode="none" name="Promociones" type="button" id='btnPromocionesCodigo' class="boton_Opcion"
                value="Promociones" />
            ...
            <input inputmode="none" name="Fidelizacion" type="button" id='btnFidelizacion' class="boton_Opcion"
                value="Fidelización" onclick="fn_modalFidelizacion(true)" />
            <!--Boton Vitality-->
            <input inputmode="none" type="button" id="btnIrPntVitality" class="boton_Opcion" value="Vitality"
                onclick="opcionSetVitality('Vitality');" />
            <input inputmode="none" type="button" id="btnCampanaSolidaria" class="boton_Opcion"
                value="Campaña Solidaria" onclick="fn_modalCampanaSolidaria();" />
            <?php
            if ($politicaEliminarTodo) {
                ?>
                <input inputmode="none" type="button" id="btnDeleteAllProduct" class="boton_Opcion"
                    value="Limpiar Productos" onclick="fnDirectDeleteAllProduct();" />
                <?php
            }
            ?>
            ...
            <input inputmode="none" name="LeerPromocion" type="button" id='btnLeerPromocion' class="boton_Opcion"
                value="Leer Promoción" onclick="fn_modalLeerPromocion(true)" />

            <!-- BTNAPPEDIR -->
            <?php if ($politicaAppedir->active) { ?>
                <input type="hidden" id="limiteCaraterAppedir" name="limiteCaraterAppedir"
                    value="<?= $politicaAppedir->limiteCaracter ?>">
                <input type="hidden" id="ApiMasivo" name="ApiMasivo"
                    value="<?= htmlspecialchars($autorizacionApiMasivo, ENT_QUOTES, 'UTF-8') ?>">
                <input inputmode="none" name="AppedirQrCodigo" type="button" id='btnAppedirQrCodigo' class="boton_Opcion"
                    value="Lealtad Masivo" onclick="fn_modalQrCodigoAppedir(true)" />
            <?php } ?>

        </div>
        <!-- Menu Derecho -->
        <div id="cnt_mn_dsplgbl_pcns_drch" class="modal_opciones_drc">
            <input inputmode="none" name="Funciones Gerente" type="button" id='funcionesGerente'
                onclick='fn_funcionesGerente()' class="boton_Opcion_Bloqueado classDisabled" value="Funciones Gerente"
                disabled="disabled" />
            <input inputmode="none" name="Transacciones" type="button" id='btn_transacciones'
                onclick='fn_irTransacciones()' class="boton_Opcion_Bloqueado classDisabled" value="Transacciones"
                disabled="disabled" />
            <input inputmode="none" name="Resumen Ventas" type="button" id='resumenVentas' onclick='fn_resumenVentas()'
                class="boton_Opcion_Bloqueado classDisabled" value="Resumen Ventas" disabled="disabled" />
            <input inputmode="none" name="Separar cuentas" servicio="2" type="button" id='separarCuentas'
                onclick='fn_separar()' class="boton_Opcion_Bloqueado classDisabled" value="Separar Cuentas" />
            <input inputmode="none" servicio="2" name="Imprimir Pre-Cuenta" type="button" id='precuenta'
                onclick='fn_CrearEImprimirPreCuenta(<?php echo $numSplit; ?>)'
                class="boton_Opcion_Bloqueado classDisabled" value="Pre Cuenta" disabled="disabled" />
            <?php
            if ($numSplit == 1) {
            ...
            ?>
            <input inputmode="none" name="Imprimir Orden Pedido" type="button" id='imprimir_orden'
                onclick='fn_imprimirOrdenPedido()' class="boton_Opcion_Bloqueado classDisabled" value="Imprimir Orden"
                disabled="disabled" />
            <input inputmode="none" name="Buscar" type="button" id='buscar' onclick='fn_modalBuscador()'
                class="boton_Opcion_Bloqueado classDisabled" value="Buscador" disabled="disabled" />
            ...
            <input inputmode="none" name="Cupones" type="button" id='btn_cuponesSG'
                class="boton_Opcion_Bloqueado classDisabled" onclick="fn_modalCupones()" value="Cupones"
                disabled="disabled" />
            <input inputmode="none" name="btnCancelarOrden" type="button" id="btnCancelarOrdenFidelizacion"
                class="boton_Opcion_Bloqueado" onclick="fn_cancelarOrdenFidelizacion()" value="Cancelar Orden"
                disabled="disabled" />
            <input inputmode="none" name="Salir" type="button" id="salir" class="boton_Opcion_Bloqueado classDisabled"
                onclick="fn_salirSistema()" value="Salir" />
        </div>
    </div>
    ...
    <div id="aumentarContador">
        ...
        <table style="margin-top: 20px">
            ...
            <tr>
                ...
                <td colspan="3">
                    <button class="btnVirtualCancelar" id="btn_punto" onclick="fn_cancelarAgregarCantidad()"
        ...
        <table>
            <tr>
                <td>
                    ...
                    <input inputmode="none" type="text" name="txt_busca" id="txt_busca"
                        style="width: 456px; height: 36px; pointer-events: none;" readonly />
                </td>
            </tr>
            <tr>
                <td>
                    <div id="buscaProducto"
                        style="height: 160px;overflow-x: hidden;overflow-y: scroll;width: 100%;padding: 10px;">
                        <table>
                            <tr></tr>
                        </table>
                    </div>
    ...
    <div id="anulacionesContenedor">
        ...
        <div class="anulacionesSeparador">
            <input inputmode="none" type="password" name="usr_clave" id="usr_clave" onchange="fn_validarUsuario()"
                style="height: 35px; width: 454px;" readonly />
        </div>
    </div>
    ...
    <div class="modal fade" id="modalPickupPedidos" data-bs-backdrop="false" data-backdrop="false"
            ...
            <div class="modal-content " style="min-height: 90vh">
                ...
                <div class="modal-body d-flex">
                    <div class="container-fluid d-flex">
                        <div id="containerPickupEmpty" class="m-auto d-none"><span style="font-weight: bolder">No hay
                                pedidos en curso</span>
                        </div>
    ...
    <div class="modal fade" id="modalPickupTiendas" data-bs-backdrop="false" data-backdrop="false"
        data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-body d-flex">
                    <div class="container-fluid">
                        ...
                        <div id="smartwizardTransferirPedido">
                            <ul class="nav">
                                <li class="nav-item"><a href="#step1" class="nav-link">Paso 1<br>
                                        <small>Tienda</small></a>
                                </li>
                                <li class="nav-item"><a href="#step2" class="nav-link">Paso 2<br>
                                        <small>Motivo</small></a>
                                </li>
    ...
    <div class="modal fade" id="modalPickupDetallesPedido" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div id="modalConfirmar" class="modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalConfirmarTitle"></h5><button type="button" class="btn-close"
    ...
    <div id="contenedorComentario">
        ...
        <br />
        <br />
        <textarea id="comentario" inputmode="none"
            style="width: 460px; height: 200px; resize:none; pointer-events: none;"></textarea>
    </div>
    ...
    <div id="contenedorCodigoBarras">
        ...
        <br />
        <br />
        <textarea id="comentariocb" style="width: 460px; height: 100px;float: right;resize:none;"
            onkeypress="validarEnter();"></textarea>
    </div>
    ...
    <div id="modalCuponSistemaGerente">
        <div class="preguntasTitulo"><label>Ingreso Cup&oacute;n Sistema
                ...
                onclick="fn_cerrarModalCuponesSistemaGerente()" class="btn_cerrar_modal_cupones" /></div>

        <div id="cnt_tp_nv_cnj_cpn" class="cnt_tp_nv_cnj_cpn">
            <div class="preguntasBotonPlu">
                <input inputmode="none" id="pcn_tp_cnj_cpn_0" class="respuestaPregunta" type="checkbox" value="0"
            ...
            <div class="preguntasBotonPlu">
                <input inputmode="none" id="pcn_tp_cnj_cpn_1" class="respuestaPregunta" type="checkbox" value="1"
                    disabled="disabled" />
            ...
            <div class="preguntasBotonPlu">
                <input inputmode="none" id="pcn_tp_cnj_cpn_2" class="respuestaPregunta" type="checkbox" value="2"
                    checked="checked" disabled="disabled" />
        ...
        <div id="aut_frm_cnj_cpn">
            <div class="anulacionesSeparador">
                <input inputmode="none" type="password" name="input_cuponSistemaGerenteAut"
                    id="input_cuponSistemaGerenteAut" onchange="fn_canjearCuponAutomatico()"
                    style="height: 35px; width: 454px;" />
            </div>
        </div>
        <div id="aut_frm_cnj_cpn_digital">
            <div class="anulacionesSeparador">
                <input inputmode="none" type="password" name="input_cuponSistemaGerenteDigital"
                    id="input_cuponSistemaGerenteDigital" onchange="fn_canjearCuponesDigitales()"
                    style="height: 35px; width: 454px;" />
            </div>
        </div>
        <div id="man_frm_cnj_cpn" style="display:none;">
            <div class="cuponesSeparador">
                <center>
                    <input inputmode="none" type="text" id="input_cuponSistemaGerenteMan1"
                    ...
                    <input inputmode="none" type="text" id="input_cuponSistemaGerenteMan2"
                        name="input_cuponSistemaGerenteMan2"
                        onclick="fn_activarCasilla('#input_cuponSistemaGerenteMan2');"
                        style="height: 35px; width: 100px;" readonly /> /
                    <input inputmode="none" type="text" id="input_cuponSistemaGerenteMan3"
                        name="input_cuponSistemaGerenteMan3"
                        onclick="fn_activarCasilla('#input_cuponSistemaGerenteMan3');"
                        style="height: 35px; width: 100px;" readonly /> /
                    <input inputmode="none" type="text" id="input_cuponSistemaGerenteMan4"
    ...
    <div id="txtPad"></div>
    <div id="keyboard"
        style="top: 294px !important; z-index: 99999 !important;height: fit-content; width: 723px !important"
        class="keyboard"></div>
    ...
    <div id="modalCuponSistemaGerenteVoucher">
        <div class="preguntasTitulo"><label id="infoMdalf">Ingreso Cup&oacute;n Sistema
                Gerente</label><img src="../imagenes/admin_resources/btn_eliminar.png"
                onclick="fn_cerrarModalCuponesSistemaGerenteVoucher()" class="btn_cerrar_modal_cupones" /></div>
        ...
        <div id="botonVolver2" style="display: none">
            <img onclick="pantalla2()" id="imgPantalla2" style="margin-top: 3%; width: 10%;"
                src="../imagenes/volverCupon.png"></img>
        </div>
        <div id="voucherAEs">
            <center><input inputmode="none" type="password" name="input_cuponSistemaGerenteAutEXT"
                    onchange="fn_canjearCuponAutomaticoVoucher()" id="input_cuponSistemaGerenteAutEXT"
    ...
    <div id="cntIntegraciones">
        <!-- Modal -->
        <div class="modal" id="mdlIntegracion" style="display: none" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" style="margin: 200px auto;width:400px;">
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    ...
                    <input inputmode="none" id="inpCodigoOrdenPedido" type="input"
                        onchange="leerCodigoOrdenPedido(this.value)" class="codigoPromocion" style="margin-top: 10px;"
                        value="" />
                </div>
                <div id="keyboard_div"></div>
                <div id="cancel_div" class="modal-footer">
                    <button type="button" id="btn_cancelModal" class="btn btn-secondary"
                        onclick="mostrarModalCodigoKiosko(false)">Cancelar
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3" style="margin-left: 137px">
                            <input inputmode="none" type="button" class="boton_Opcion" value="Retomar Orden"
                                onclick="mostrarModalCodigoKiosko(true)" />
                            <input inputmode="none" type="button" class="boton_Opcion" value="Reimpresión"
                                onclick="procesoReimpresion()" />
                            <input inputmode="none" type="button" class="boton_Opcion" value="Anular Orden"
                                onclick="confirmarAnularOrdenKiosko()" />
                            <input inputmode="none" type="button" class="boton_Opcion" value="Transferir Orden"
    ...
    <div id="modalLocalesTransferenciaPickup" class="modal fade bs-example-modal-sm" style="overflow-y: hidden;"
                ...
                <div class="panel panel-primary" style="margin-bottom:0px; ">
                    ...
                    <div class="panel-body" id="footerLocales" style="padding: 0">
                        <button class="btn_cerrar"
                            onClick="$('#modalLocalesTransferenciaPickup').modal('toggle')">Cerrar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="modalMotivoTransferenciaPickup" class="modal fade bs-example-modal-sm" style="overflow-y: hidden;"
        tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="panel panel-primary" style="margin-bottom:0px; ">
                    ...
                    <div class="panel-body" id="footerMotivos" style="padding: 0; width: 100%;">
                        <button class="btn_cerrar"
                            onClick="$('#modalMotivoTransferenciaPickup').modal('toggle')">Cerrar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input inputmode="none" id="inpCodigoSeguridad" type="password"
                        onchange="leerCodigoSeguridad(this.value)" class="codigoPromocion" value="" />
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input inputmode="none" type="text" name="cc_month" id="inpCodigoPromocion" value="" class="input"
                        ...
                        placeholder="" minlength="fn_numerico10" maxlength="13" required="" />
                </div>

                <div style="height: 90px">
                    <button type="button" class="boton_Opcion" onclick="fn_modalLeerPromocion(false)">Cancelar</button>
                    <button type="button" class="boton_Opcion"
                        onclick="pay_numericoCliente('#inpCodigoPromocion')">Teclado</button>
                </div>
    ...
    <div id="mdlQrCodigoAppedir" class="modal_cargando" style="display: none">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="parrafoPromocion">Lea el código QR o escriba el código ubicado debajo del mismo.</p><br />
                    <input inputmode="none" type="text" name="cc_month" id="inpCodigoQrAppedirNew" value=""
                        class="input" placeholder="" onkeydown="odp_okQrAppedir(event)" minlength="1"
                        maxlength="<?= $politicaAppedir->limiteCaracter ?>" required="" />
                    <!--<div class="botones">
                ...
                <div style="height: 90px">
                    <button type="button" class="btn-danger boton_Opcion"
                        onclick="fn_modalQrCodigoAppedir(false)">Cancelar</button>
                    <button type="button" class="btn-primary boton_Opcion"
                        onclick="pay_numericoCliente('#inpCodigoQrAppedirNew')">Ingreso manual</button>
                </div>
    ...
    <div class="modal modal-payphone" id="ModalRegistroDatosDomicilio" style="display: none">
        <div class="modal__container">
            <div class="modal__content">
                <ul class="form-list">
                    <input inputmode="none" type="hidden" value="<?php if (isset($_SESSION['acepta_beneficio'])) {
                        echo $_SESSION['acepta_beneficio'];
                    } ?>" id="acepta_beneficio">
                    <li class="text-center botones" id="botones_cabecera">
                        ...
                        <button type="button" id="pasaporte_validar" class="button"
                            onclick="fn_solicitaCredencialesAdministrador()">Pasaporte</button>
                    </li>
                    <li id="botones_domicilio" style="justify-content: space-between;">
                        <button id="btn_salirOrden" class="otro_documento" onclick="pedirDatosDocumento()"
                            id="closeModal" title="Retomar Orden"></button>
                        <button type="button" onclick="fn_activarEsDomicilio();" id="es_domicilio"
                            class="button">Domicilio</button>
                    </li>
                        ...
                        <ul>
                            <li class="form-list__row padding_top">
                                <div class="form-list__input-inline">
                                    ...
                                    <input inputmode="none" type="text" name="cc_month" id="pay_txtCedulaCliente"
                                        value="" class="input" desc="Cédula/Ruc"
                                        ...
                                        placeholder="" minlength="fn_numerico10" maxlength="13" required="" readonly />
                                </div>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul>
                            <li class="form-list__row padding_top">
                                <div class="form-list__input-inline">
                                    ...
                                    <input inputmode="none" class="input" id="pay_txtNombres"
                                        onclick="pay_alfaNumericoCliente('#pay_txtNombres');" desc="Nombres" type="text"
                                        name="" />
                                </div>
                            </li>
                            <li class="form-list__row padding_top">
                                <div class="form-list__input-inline">
                                    ...
                                    <input inputmode="none" type="text" name="cc_year" id="pay_txtTelefono"
                                        class="input" desc="Teléfono" onclick="pay_numericoCliente('#pay_txtTelefono');"
                        ...
                        <ul>
                            <li class="form-list__row padding_top">
                                <div class="form-list__input-inline1">
                                    ...
                                    <input inputmode="none" type="text" name="cc_month" desc="Calle Principal"
                                        id="pay_txtDireccion" onclick="pay_alfaNumericoCliente('#pay_txtDireccion');"
                                        onchange="fn_quitar_coordendas();" class="input ajustar" placeholder=""
                                        minlength="2" maxlength="400" />
                                    <label lass="ajustar"> #</label>
                                    <input inputmode="none" type="text" name="cc_year" desc="Número Calle"
                                        id="pay_numeroCallePrincipal"
                                        onclick="pay_alfaNumericoCliente('#pay_numeroCallePrincipal');"
                                        style="width: 100px;" class="input ajustar" placeholder="" minlength="2"
                                        maxlength="100" />
                                </div>
                            </li>
                            <li class="form-list__row padding_top">
                                <label>Calle secundaria</label>
                                <input inputmode="none" class="input" desc="Calle Secundaria"
                                    onclick="pay_alfaNumericoCliente('#pay_calleSecundaria');" id="pay_calleSecundaria"
                                    type="text" name="" />
                            </li>
                            <li class="form-list__row padding_top">
                                <div class="form-list__input-inline1">
                                    ...
                                    <label lass="ajustar"> #</label>
                                    <input inputmode="none" type="text" id="pay_referenciaTipoInmueble"
                                        onclick="pay_alfaNumericoCliente('#pay_referenciaTipoInmueble');"
                                        desc="Tipo Inmueble" name="cc_year" style="width: 100px;" class="input ajustar"
                                        placeholder="" minlength="2" maxlength="10" required="" />
                                </div>
                            </li>
                            <li class="form-list__row">
                                <label>Referencia / Observación </label>
                                <textarea id="pay_referencia" onclick="pay_alfaNumericoCliente('#pay_referencia');"
                                    desc="Referencia" class="input" rows="1" cols="50"></textarea>
                    ...
                    <li class="text-center botones align-center justify-content-center" id="botones_primeros">
                        <button type="submit"
                            onclick="fn_buscarCliente('#pay_txtCedulaCliente', <?php echo $restaurant_valida_email; ?>);"
                            id="btn_consultar" class="button">Consultar</button>
                        <button type="button" id="btn_consumidor" onclick="cancelarPayPhone()"
                            style="background-color: rgb(193, 34, 34);" class="button">Consumidor Final</button>
                    </li>
                    <li class="text-center botones align-center justify-content-center" id="botones_segundos">
                        <button type="submit" onclick="modalAgregaBeneficio(true);" id="btn_beneficio"
                            class="button">Agregar Beneficio</button>
                        <button type="submit" onclick="ejecutarOpcionesGuardar();" id="btn_opcionesGuardar"
                            style="background-color: rgb(193, 34, 34);" class="button">Aceptar</button>
                    </li>
                    <div class="teclado_clientes">
                        <div class="numPad"></div>
                        <div class="txtPad"></div>
            ...
            <div class="modal__content">
                <div class="contenido">
                    <div class="preguntasTitulo">
                        ...
                        <img src="../imagenes/admin_resources/btn_eliminar.png" onclick="cerraModalAgregaBeneficio()"
                            class="btn_cerrar_modal_cupones" />
                    </div>
                    <div id="cnt_tp_nv_cnj_cpn" class="cnt_tp_nv_cnj_cpn">
                        <div class="preguntasBotonPlu">
                            <input inputmode="none" id="btn_cl_ben_1" class="respuestaPregunta" type="checkbox"
                                value="0" checked="checked" disabled="disabled" />
                            <label onclick="fn_procesoCanjearAutomaticoCedula()" for="btn_cl_ben_1">
                                <p>Autom&aacute;tico</p>
                            </label>
                        </div>
                        <div class="preguntasBotonPlu">
                            <input inputmode="none" id="btn_cl_ben_2" class="respuestaPregunta" type="checkbox"
                    ...
                    <div id="aut_frm_cnj_cpn_lnd">
                        <input inputmode="none" type="tel" name="input_cedulaBeneficio"
                            onkeydown="odp_buscarClienteBeneficio(event)" id="input_cedulaBeneficio" />
                    </div>
    ...
    <div id="div_adminPasaporte" title="Ingrese las Credenciales del Administrador" align="center"
        ...
        <div class="anulacionesSeparador">
            <div class="anulacionesInput" align="center">
                <input inputmode="none" type="password" id="txt_passPasaporte"
                    style="height: 40px; width: 454px; font-size: 16px;" />
            </div>
        </div>
        <table id="tabla_credencialesAdmin" align="center">
            <tr>
                <td><button style="font-size:45px;" class='btnVirtual'
                        onclick="fn_agregarCaracterNum(txt_passPasaporte, 7)">7</button></td>
                <td><button style="font-size:45px;" class='btnVirtual'
                        onclick="fn_agregarCaracterNum(txt_passPasaporte, 8)">8</button></td>
                <td><button style="font-size:45px;" class='btnVirtual'
                        onclick="fn_agregarCaracterNum(txt_passPasaporte, 9)">9</button></td>
                <td><button style="font-size:45px;" class='btnVirtualOKpq'
                        onclick="fn_eliminarNumero(txt_passPasaporte);">&larr;</button></td>
            </tr>
            <tr>
                <td><button style="font-size:45px;" class='btnVirtual'
                        onclick="fn_agregarCaracterNum(txt_passPasaporte, 4)">4</button></td>
                <td><button style="font-size:45px;" class='btnVirtual'
                        onclick="fn_agregarCaracterNum(txt_passPasaporte, 5)">5</button></td>
                <td><button style="font-size:45px;" class='btnVirtual'
                        onclick="fn_agregarCaracterNum(txt_passPasaporte, 6)">6</button></td>
                <td><button style="font-size:45px;" class='btnVirtualOKpq'
                        onclick="fn_eliminarTodo(txt_passPasaporte);">&lArr;</button></td>
            </tr>
            <tr>
                <td><button style="font-size:45px;" class='btnVirtual'
                        onclick="fn_agregarCaracterNum(txt_passPasaporte, 1)">1</button></td>
                <td><button style="font-size:45px;" class='btnVirtual'
                        onclick="fn_agregarCaracterNum(txt_passPasaporte, 2)">2</button></td>
                <td><button style="font-size:45px;" class='btnVirtual'
                        onclick="fn_agregarCaracterNum(txt_passPasaporte, 3)">3</button></td>
                <td><button style="font-size:45px;" class='btnVirtualOKpq' id="fn_okPasaporte"
                        onclick="fn_okPasaporte();">OK</button></td>
            </tr>
            <tr>
                <td><button style="font-size:45px;" class='btnVirtual'
                        onclick="fn_agregarCaracterNum(txt_passPasaporte, 0)">0</button></td>
                <td colspan="4"><button style="font-size:45px;" class='btnVirtualCancelar'
                        onclick="fn_canPasaporte();">Cancelar</button></td>
            </tr>
        </table>
    </div>
    ...
    <!-- Nombrar picada -->
    <div class="modal" id="modalNombrarPicada" tabindex="-1" aria-labelledby="modalNombrarPicadaLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content modal-content-nombrarPicada">
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <h5><label for="nombrePicada" class="col-form-label"><strong>Introduzca el nombre de la
                                        picada:</strong></label></h5>
