...
if ($method == '') {
	...
	echo '<input inputmode="none"  type="hidden" name="proxyhost" value="' . $proxyhost .'">';
	echo '<input inputmode="none"  type="hidden" name="proxyport" value="' . $proxyport .'">';
	echo '<input inputmode="none"  type="hidden" name="proxyusername" value="' . $proxyusername .'">';
	echo '<input inputmode="none"  type="hidden" name="proxypassword" value="' . $proxypassword .'">';
	...
	echo '</select><br><br>';
	echo 'Null parameter? <input inputmode="none"  type="checkbox" name="null" value="1"><br>';
	echo 'Empty array? <input inputmode="none"  type="checkbox" name="empty" value="1"><br><br>';
	echo '<input inputmode="none"  type="submit" value="&#160;Execute&#160;">';
	echo '</form>';
	exit();
}
/*
