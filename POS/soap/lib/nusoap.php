...
//		}
	...
	* @access   public
	*/
	function send($data, $timeout=0, $response_timeout=90, $cookies=NULL) {
	...
	* @deprecated
	*/
	function sendHTTPS($data,$cookies, $timeout=0, $response_timeout=90 ) {
...
class wsdl extends nusoap_base {
     ...
     * @access public 
     */
    function __construct($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout=90,$curl_options=null,$use_curl=false){
		parent::__construct();
...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function __construct($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 90, $portName = ''){
		parent::__construct();
